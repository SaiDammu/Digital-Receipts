...
@property (nonatomic, strong) TableViewAlertNumberOfRowsBlock numberOfRows;
@property (nonatomic, strong) TableViewAlertTableCellsBlock cells;
...
#pragma mark - TableViewAlert Class Method
...
#pragma mark - TableViewAlert Initialization

-(id)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle numberOfRows:(TableViewAlertNumberOfRowsBlock)rowsBlock andCells:(TableViewAlertTableCellsBlock)cellsBlock
{
...
-(void)show
{
	...
	UIImageView *alertBgImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"TableViewAlertBackground.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:30]];
	...
	UIImageView *maskShadow = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"TableViewAlertShadowMask.png"] stretchableImageWithLeftCapWidth:6 topCapHeight:7]];
	...
	[self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"TableViewAlertButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
	[self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"TableViewAlertButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
