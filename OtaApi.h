...
///
#define UUID_OTA_SERVICE_DEF                 @"FEE8"
#define UUID_OTA_SERVICE                 @"0000fee8-0000-1000-8000-00805f9b34fb"
...
- (void) otaEnable : (CBPeripheral *)aPeripheral
   withServiceUUID : (NSString *)otaServiceUUID;
